...
#include"FILE_SIZE.h" /* float FILE_SIZE(FILE*)*/
...
printf("Successfully Undeleted File(s)\n");
printf("File Name: %s \n",INPUT_FILE_NAME);
printf("File Size: %.1f GB \n",FILE_LENGTH);
printf("%d JPG File(s) Recovered \n",BUFFET-ONE);
printf("Credit: GCT@Prince-Mughal \n");
fclose(READER);
fclose(WRITTER);
